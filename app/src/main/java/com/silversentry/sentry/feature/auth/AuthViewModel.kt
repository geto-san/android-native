...
import com.silversentry.sentry.core.data.auth.AuthErrorMapper
...
class AuthViewModel @Inject constructor(
    ...
    // One-shot signal SilverBackSentryNavHost collects to leave the Auth screen the same way it does
