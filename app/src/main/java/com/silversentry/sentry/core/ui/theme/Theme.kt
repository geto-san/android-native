package com.silversentry.sentry.core.ui.theme
...
private val DarkColors = darkColorScheme(
    ...
    onSecondary = White,
    tertiary = ForestGreenGlow,
    onTertiary = White,
    background = PureBlack,
    onBackground = White,
    surface = DarkGrey100,
    onSurface = White,
    surfaceVariant = DarkGrey200,
    onSurfaceVariant = DarkGrey500,
    error = Destructive,
    onError = White,
    outline = DarkGrey300,
)
...
private val SilverBackSentryShapes = Shapes(
