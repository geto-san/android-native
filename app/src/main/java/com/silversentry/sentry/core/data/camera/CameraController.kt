package com.silversentry.sentry.core.data.camera
...
// both display and the later Firebase Storage upload (IncidentRemoteDataSourceImpl
...
class CameraController @Inject constructor() {
    ...
    suspend fun takePhoto(context: Context): Result<String> {
        ...
        val photoFile = File(context.filesDir, "incident_$timestamp.jpg")
