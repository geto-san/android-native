...
Cloud Functions have a Jest test suite exercising the trigger-dispatch logic, the bridge's HMAC signing and echo-prevention functions in isolation, and the role-assignment callable's authorization logic. Coverage is deliberately prioritized toward the bridge and authorization code rather than the full surface — see `/home/geto/Projects/Documentations/WildWatch/root-contracts/BRIDGE-CONTRACT.md` and the punch-list history referenced from `/home/geto/Projects/Documentations/WildWatch/root-contracts/AGENTS.md` for what's covered and what still needs attention.
